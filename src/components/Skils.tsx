...
export function Skils(){
    ...
    const educations = [
        ...
        {
            name: "Unipar - Universidade Paranaense - Pós-graduação Lato Sensu - Especialização - Dispositivos Móveis",
        },
        {
            name: "Unipar - Universidade Paranaense - Bacharelado - Tecnologia da Informação",
        },
