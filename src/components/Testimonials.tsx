...
export function Testimonials(){
    return (
        ...
        <figure>
          ...
          <figcaption className="flex items-center justify-center gap-2">
            ...
            <div className="flex items-center divide-x-2 divide-gray-200">
              <div className="pr-3 font-medium text-gray-900">Giovani Debona</div>
        ...
        <figure>
          ...
          <blockquote className="mb-6">
            <p className="text-2xl text-gray-900">
              João está desenvolvendo nosso site, isto irá facilitar a vida dos membros da nossa igreja
            </p>
          </blockquote>
          <figcaption className="flex items-center justify-center gap-2">
            <img
            ...
            />
            <div className="flex items-center divide-x-2 divide-gray-200">
              <div className="pr-3 font-medium text-gray-900">Igreja Luterana Paz</div>
              <div className="pl-3 text-sm font-light text-gray-500">
                Igreja Luterana Paz
              </div>
            </div>
